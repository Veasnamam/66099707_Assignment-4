...
function divisibleByThree(number){
    if(number%3 == 0){
        console.log(true+ ", the number " +number+ " is divisible by 3");
    }else{
        console.log(false+ ", the number " +number+ " is not divisible by 3");
    }
}
divisibleByThree(21);
...
function leetSpeak(word){
    for(let i=0; i<word.length; i++){
        if(word.includes('e')){
            console.log(word.replaceAll('e',3));
